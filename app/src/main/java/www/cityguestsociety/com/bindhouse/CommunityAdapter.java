...
public class CommunityAdapter extends BaseAdapter {
    ...
    private List<Community> mCities;
    ...
    public CommunityAdapter(Context mContext, List<Community> mCities, List<NetworkCityBean> networkHotCityBeen) {
      ...
      /*  mCities.add(0, new Community("#", "0"));
        mCities.add(1, new Community("热门城市", "1"));*/
   ...
   /* @Override
    ...
    public View getView(final int position, View view, ViewGroup parent) {
       ...
       /* int viewType = getItemViewType(position);
        ...
        final String city = mCities.get(position).getCommunity();
