...
/**
 * Created by LuoPan on 2017/6/6.
 */

@SuppressLint("AppCompatCustomView")
public class RoundImageViewr extends ImageView {
    ...
    public RoundImageViewr(Context context) {
    ...
    public RoundImageViewr(Context context, AttributeSet attrs) {
    ...
    public RoundImageViewr(Context context, AttributeSet attrs, int defStyle) {
